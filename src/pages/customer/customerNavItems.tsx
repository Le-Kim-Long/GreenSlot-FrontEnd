import { Leaf, Wifi, TrendingUp, CreditCard, Bell, Sprout, Grid3X3, History, Camera } from 'lucide-react';
...
export const customerNavItems = [
  ...
  { label: 'Camera', path: '/dashboard/customer/cameras', icon: <Camera className="w-full h-full" /> },
